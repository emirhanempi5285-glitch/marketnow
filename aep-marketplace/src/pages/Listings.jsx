...
const LISTINGS = [
  {
    ...
    whatWeFixed: [
      'description said "8,535+ verified skills" → now says "8,560 MCP-compatible skills"',
      'readme said "5,054+ verified MCP skills" → now says "8,560 MCP skills"',
      'Added "trust layer for agent commerce" positioning',
      'Added review_status, permissions, AP2, x402 mentions',
    ],
    notes: 'npm package v1.2.0 published with corrected numbers and new positioning. The old v1.1.0 is still cached in some mirrors but will propagate within 24h.',
  },
  {
    name: 'Smithery',
    ...
    whatWeFixed: [
      ...
      'Our server-card.json is up to date with current numbers',
    ],
    notes: 'Smithery quality score: 84/100. Listing should reflect current data if Smithery re-crawls. If you see stale data on Smithery, it may be their cache.',
  },
  {
    name: 'mcp.so',
    url: 'https://mcp.so',
    ...
    lastChecked: '2026-07-02',
    whatWeFixed: [
      'We cannot directly edit the mcp.so listing — it appears to be auto-scraped or user-submitted, and mcp.so is behind Cloudflare anti-bot protection (we cannot verify the exact content programmatically).',
    ],
    knownDiscrepancies: [
      'Listing reportedly says "13,859 verified MCP-compatible skills" — should be 8,560',
      'Listing reportedly says "agent-to-agent crypto payments (ETH/BSC/SOL/BTC)" — we only support USDC on Base, not ETH/BSC/SOL/BTC directly',
      'Listing reportedly says "open registry with no manual approval needed" — we removed this framing; human-in-loop is now the default for mandates',
      'Listing reportedly says "largest open MCP skill marketplace" — we no longer claim to be the largest; we position as the trust layer',
    ],
    notes: 'If you are the mcp.so listing owner or maintainer, please update the listing to match our current positioning. The current description on mcp.so contradicts our actual capabilities and overstates what we support (4 chains vs 1, 13K vs 8.5K skills). We are working on contacting mcp.so to request an update.',
  },
  {
    name: 'Glama.ai',
    url: 'https://glama.ai',
    ...
    lastChecked: '2026-07-02',
    whatWeFixed: [
      'Not currently listed on Glama.ai (404 on our server URL).',
      'We can submit if there is a public submission process.',
    ],
    notes: 'Glama.ai is a discovery directory. If they accept submissions, we will list ourselves with the current honest positioning.',
  },
  {
    name: 'PulseMCP',
